...
public class SearchGongSiAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public SearchGongSiAdapter(Context context, List<GongsiItem> dataList) {
