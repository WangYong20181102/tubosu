...
import com.tbs.tbs_mj.adapter.DecoCaseDetailAdapter;
 ...
 * 头部包含相关信息
 */
public class DecorationCaseDetailActivity extends com.tbs.tbs_mj.base.BaseActivity {
    ...
    public void onViewClickedInDecorationCaseDetailActivity(View view) {
        switch (view.getId()) {
            ...
            case R.id.deco_case_detail_find_price_rl:
                ...
                intent.putExtra("mLoadingUrl", SpUtil.getzjzxaj20(mContext));
