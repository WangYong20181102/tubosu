...
import com.tbs.tbs_mj.adapter.DesignerListAdapter;
import com.tbs.tbs_mj.base.*;
import com.tbs.tbs_mj.bean._DesignerItem;
 ...
 * 从装修公司首页点解更多进入
 */
public class DesignerListActivity extends com.tbs.tbs_mj.base.BaseActivity {
    ...
    public void onViewClickedInDesigerListActivity(View view) {
        switch (view.getId()) {
            ...
            case R.id.designer_list_price_rl:
                ...
                intent.putExtra("mLoadingUrl", SpUtil.getzjzxaj23(mContext));
        ...
        public void onItemClickLister(View view, int position) {
            switch (view.getId()) {
                ...
                case R.id.item_designer_find_he_design:
                    ...
                    Intent intent = new Intent(mContext, NewWebViewActivity.class);
                    intent.putExtra("mLoadingUrl", SpUtil.getzjzxaj22(mContext));
                    mContext.startActivity(intent);
                    break;
            }
        }
