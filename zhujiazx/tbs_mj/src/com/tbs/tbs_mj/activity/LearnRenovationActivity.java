...
import com.tbs.tbs_mj.adapter.MyFragmentPagerStateAdapter;
import com.tbs.tbs_mj.adapter.PopMoreStyleAdapter;
import com.tbs.tbs_mj.base.*;
import com.tbs.tbs_mj.bean._ArticleType;
import com.tbs.tbs_mj.fragment.ArticleTypeFragment;
 ...
 * create by lin
 */
public class LearnRenovationActivity extends com.tbs.tbs_mj.base.BaseActivity {
    ...
    public void onViewClickedInLearnRenovation(View view) {
        switch (view.getId()) {
            ...
            case R.id.learn_rovat_fadan_rl:
                ...
                intent.putExtra("mLoadingUrl", SpUtil.getzjzxaj27(mContext));
                mContext.startActivity(intent);
                break;
            case R.id.learn_rovat_right_anim:
                //点击右侧的动画进行发单
                Intent intent1 = new Intent(mContext, NewWebViewActivity.class);
                intent1.putExtra("mLoadingUrl", SpUtil.getzjzxaj28(mContext));
