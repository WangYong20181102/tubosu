...
import com.tbs.tbs_mj.adapter.DesignCaseAdapter;
import com.tbs.tbs_mj.base.*;
import com.tbs.tbs_mj.bean.EC;
import com.tbs.tbs_mj.bean.Event;
import com.tbs.tbs_mj.bean._CompanySuiteList;
 ...
 */
public class DesignCaseActivity extends com.tbs.tbs_mj.base.BaseActivity {
        ...
        public void onItemClick(View view, int position) {
            switch (view.getId()) {
                ...
                case R.id.item_design_case_get_design:
                    ...
                    intent2.putExtra("mLoadingUrl", SpUtil.getzjzxaj16(mContext));
    ...
    public void onViewClickedInDesignCaseActivity(View view) {
        switch (view.getId()) {
            ...
            case R.id.design_case_find_price_rl:
                ...
                intent.putExtra("mLoadingUrl",SpUtil.getzjzxaj17(mContext));
                mContext.startActivity(intent);
                break;
        }
    }
