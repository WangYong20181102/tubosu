...
public class CollectSampleImgAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener{
    ...
    private ArrayList<CollectionSampleJsonEntity.CollectionSampleImg> dataList;

    public CollectSampleImgAdapter(Context mContext, ArrayList<CollectionSampleJsonEntity.CollectionSampleImg> dataList){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof SamplePicViewHolder){
            ...
            itmeHolder.tv_pic_num.setVisibility(View.GONE);
            itmeHolder.sdiv.setVisibility(View.GONE);
...
//        }
    ...
    public class SamplePicViewHolder extends RecyclerView.ViewHolder{
        ...
        public SamplePicViewHolder(View itemView) {
            ...
            sdiv = (ImageView) itemView.findViewById(R.id.sdiv);
