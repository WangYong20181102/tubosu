...
//        AppInfoUtil.setTitleBarColor(SmartDesignActivity.this, R.color.bg_fd_title);
    ...
    private void initLocationCity() {
        String cityName = CacheManager.getCity(mContext);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.fd_city:
                    ...
                    Bundle b = new Bundle();
                    b.putString("from_home_getcity", "66");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 71) {
            Bundle b = data.getBundleExtra("city_bundle");
            String city = b.getString("ci");
            if (!TextUtils.isEmpty(city)) {
                mCityName = getSharedPreferences("Save_City_Info", MODE_PRIVATE).getString("save_city_now", city);
