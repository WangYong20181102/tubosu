...
public class ClearCacheDialog extends Dialog {
    ...
    public ClearCacheDialog(Context context, int theme) {
        super(context, theme);
        this.setCanceledOnTouchOutside(false);
        this.setCancelable(false);
    }
    ...
    public static class Builder {
        ...
        public ClearCacheDialog create() {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            final ClearCacheDialog dialog = new ClearCacheDialog(context, R.style.warn_dialog_style);
            View layout = inflater.inflate(R.layout.clearcache_dialog_layout, null);
