...
public class OtherAdapter extends BaseAdapter {
	...
	public OtherAdapter(Context context, List<DecorateTitleEntity.ChannelItem> channelList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		View view = LayoutInflater.from(context).inflate(R.layout.other_channel_item, null);
		item_text = (TextView) view.findViewById(R.id.other_text_item);
