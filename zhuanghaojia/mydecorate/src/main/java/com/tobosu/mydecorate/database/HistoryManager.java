...
public class HistoryManager {
    ...
    private HistoryManager(Context mContext){
        this.mContext = mContext;
        dBHelper = HistoryHelper.getInstance(mContext);
    }

    public static HistoryManager getInstance(Context mContext){
        if(manager == null){
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                if(string.equals(text)){
                    ...
                    String[] args = {text};
                    values.put("history_date", historyTime);
//                    // Search_History_Data       history_text        history_date
                    db.update("Search_History_Data", values, "history_text=?", args);
