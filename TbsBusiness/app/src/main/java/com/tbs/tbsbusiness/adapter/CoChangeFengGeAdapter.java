...
/**
 * Created by Mr.Lin on 2018/6/7 14:30.
 */
public class CoChangeFengGeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
        implements View.OnClickListener {

    private Context mContext;
    private String TAG = "CoChangeFengGeAdapter";
    private ArrayList<_MyStore.GoodAtStyleBean> mGoodAtStyleBeanArrayList;
    ...
    public CoChangeFengGeAdapter(Context context, ArrayList<_MyStore.GoodAtStyleBean> goodAtStyleBeanArrayList) {
        this.mContext = context;
        this.mGoodAtStyleBeanArrayList = goodAtStyleBeanArrayList;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            //设置文本显示信息
            ((ItemViewHolder) holder).item_co_change_name_tv.setText("" + mGoodAtStyleBeanArrayList.get(position).getName());
            //设置状态
    ...
    public int getItemCount() {
        return mGoodAtStyleBeanArrayList != null ? mGoodAtStyleBeanArrayList.size() : 0;

    }

    @Override
    public void onClick(View v) {
        if (onItemClickLister != null && !mGoodAtStyleBeanArrayList.isEmpty()) {
