...
public class CheckPhoneNumActivity extends BaseActivity {
    ...
    @OnClick({R.id.check_phone_num_back, R.id.check_phone_num_clean, R.id.check_get_code, R.id.check_next_step_btn})
                    ...
                    if (status.equals("200")) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                checkGetCode.setBackgroundResource(R.drawable.shape_get_code_affter);
                                startCount();
                            }
                        });
                    } else if (status.equals("203")) {
        ...
        public void run() {
            if (count > 0 && checkGetCode != null) {
                ...
                if (checkGetCode != null) {
                    ...
                    checkGetCode.setBackgroundResource(R.drawable.shape_login_get_code);
