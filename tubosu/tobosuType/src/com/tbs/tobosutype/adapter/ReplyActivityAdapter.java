...
import com.tbs.tobosutype.activity.ReplyActivity;
 ...
 */
public class ReplyActivityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ReplyActivity context;
    private ArrayList<String> stringList;
    private final LayoutInflater inflater;

    public ReplyActivityAdapter(ReplyActivity context, ArrayList<String> stringList) {
