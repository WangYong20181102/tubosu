...
public class BaseSeekBar extends View {
    ...
    private static final int DEFAULT_BAR_COLOR = Color.parseColor("#E3D9D0");
    private static final float DEFAULT_CONNECTING_LINE_WEIGHT_PX = 9;
    ...
    protected int mThumbColorPressed = Color.parseColor("#CCB0A0");
