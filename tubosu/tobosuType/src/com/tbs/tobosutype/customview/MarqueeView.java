...
public class MarqueeView extends ViewFlipper {
    ...
    private View createView(int position) {
        ...
        final TextView tvMarquee = (TextView) view.findViewById(R.id.tvMarquee);
        tvMarquee.setText(marquee.getTitle());
        if (isImage) {
            ivMarquee.setVisibility(VISIBLE);
            Glide.with(mContext)
                    .load(marquee.getImgId())
        ...
        tvMarquee.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (text.contains("设计")) {
                    webIntent.putExtra("mLoadingUrl", SpUtil.getTbsAj06(context));
                } else if (text.contains("报价")) {
                    webIntent.putExtra("mLoadingUrl", SpUtil.getTbsAj07(context));
                } else if (text.contains("推荐")) {
                    webIntent.putExtra("mLoadingUrl", SpUtil.getTbsAj09(context));
                } else if (text.contains("礼包")) {
                    webIntent.putExtra("mLoadingUrl", SpUtil.getTbsAj08(context));
                }
