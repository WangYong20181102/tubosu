...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		mRefreshViewText = (TextView) mRefreshHeaderView.findViewById(R.id.pull_to_refresh_text_);
		mRefreshViewImage = (ImageView) mRefreshHeaderView.findViewById(R.id.pull_to_refresh_image_);
		mRefreshViewProgress = (ProgressBar) mRefreshHeaderView.findViewById(R.id.pull_to_refresh_progress_);
		mRefreshViewLastUpdated = (TextView) mRefreshHeaderView.findViewById(R.id.pull_to_refresh_updated_at_);
		mLoadMoreFooterView = (RelativeLayout) mInflater.inflate(R.layout.loadmore_footer, this, false);
